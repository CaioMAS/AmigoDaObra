function criarP(text) {
 ...
 function limparInput () {
    ...
    var espessuraChapisco = document.getElementById('espessuraChapisco').value = '' 
    var areaDoChapisco = document.getElementById('areaDoChapisco').value = '' 
}
...
var espessuraChapisco = document.getElementById('espessuraChapisco') // se transforma em C
var areaDoContraPiso = document.getElementById('areaDoChapisco') // se transforma em D
...
calcMaterialBtn.addEventListener('click', function () {
    ...
    var c = Number(espessuraChapisco.value)
    var d = Number(areaDoChapisco.value)

    var quantAreia = ((d*c*1.05/1000)).toFixed(2)
